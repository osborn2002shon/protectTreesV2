<%@ Page Title="" Language="C#" MasterPageFile="~/_mp/mp_backstage.Master" AutoEventWireup="true" CodeBehind="uploadPhoto.aspx.cs" Inherits="protectTreesV2.backstage.patrol.uploadPhoto" %>
        ...
        <div class="col-12">
            <div class="card border-dark">
                ...
                <div class="card-body pt-0">
                    ...
                    <ul>
                        <li>
                            <strong>命名規則：</strong>系統樹籍編號_巡查日期_xxxx.jpg
                    ...
                    <ul>
                        <li>
                            ...
                            若系統中查無該「樹籍編號」與「巡查日期」的對應紀錄，系統將自動建立一筆新的草稿資料以利歸檔照片。
                        </li>
                    </ul>
