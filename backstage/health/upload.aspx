<%@ Page Title="" Language="C#" MasterPageFile="~/_mp/mp_backstage.Master" AutoEventWireup="true" CodeBehind="upload.aspx.cs" Inherits="protectTreesV2.backstage.health.upload" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_content" runat="server">
    <nav class="nav nav-tabs mb-4">
        ...
        <a class="nav-link active" href="upload.aspx">上傳多筆健檢紀錄</a>
