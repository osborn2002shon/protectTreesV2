...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_content" runat="server">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col">
                                    ...
                                    <asp:Button ID="btnCoordinateTool" runat="server" Text="開啟座標轉換小工具" CausesValidation="false" OnClientClick="openCoordinateModal(); return false;" CssClass="btn btn-primary" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
    ...
    <div class="row">
        <div class="col text-center">
            ...
            <asp:Label runat="server" AssociatedControlID="chkFinalConfirm" CssClass="form-check-label" Text="儲存為定稿" /><br />
            定稿視為正式資料，無法退回草稿狀態，並將開放後台使用者查詢檢視（樹籍狀態為公告列管才會顯示於前台）
            <br />
            <asp:LinkButton ID="LinkButton_btnSave" runat="server" OnClick="btnSave_Click" OnClientClick="return confirmSave();" 
                CssClass="btn btn_main">
                <i class="fa-solid fa-floppy-disk me-1"></i>儲存
            </asp:LinkButton>
            <asp:LinkButton ID="LinkButton_btnCancel" runat="server" Text="" CausesValidation="false" OnClick="btnCancel_Click" OnClientClick="return confirmNavigate();" 
                CssClass="btn btn_main_line">
    ...
    <div class="row mt-2">
        <div class="col">
            <div class="formCard card">
                ...
                <div class="card-body">
                    1. 定稿視為正式資料，無法退回草稿狀態，並將開放後台使用者查詢檢視。<br />
                    2. 樹籍狀態若為「已公告列管」，則「公告日期」為必填項目，並且此樹將顯示於前台可被民眾查看。<br />
                    3. 標示為<i class="fa-solid fa-eye"></i>之項目，內容將顯示於前台可被民眾查看。
                </div>
                <div class="card-footer"></div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="coordinateModalLabel">座標轉換小工具</h5>
